            ...
            <div class="row">
                <div class="col-6">
                    ...
                    <table class="table table-bordered table-hovered" style="">
                        ...
                        <tr>
                            <td> Name </td>
                            <td> {{ $meetings_events->name }}</td>
                        </tr>
                        <tr>
                            <td> Property Label Name </td>
                            <td> {{ $meetings_events->property_label }}</td>
                        </tr>
                        <tr>
                            <td> Rate in BTD(৳) </td>
                            <td> {{ $meetings_events->rate_in_bdt }}</td>
                        </tr>
                        <tr>
                            <td> Rate in USD($) </td>
                            <td> {{ $meetings_events->rate_in_usd }}</td>
                        </tr>

                        <tr>
                            <td> Feature Image </td>
                            <td> <img height="160" width="260" src="{{ asset($meetings_events->feature_image) }}" /></td>
                        </tr>
                        <tr>
                            <td> Gallary Image </td>
                            <td>
                        ...
                        <tr>
                            <td> Property List </td>
                            <td>{{ $meetings_events->property_list ? $meetings_events->property_list : '' }} </td>
                        </tr>
                        <tr>
                            <td> Description </td>
                            <td> {{ $meetings_events->description }}</td>
                        </tr>
                    </table>

...
@section('content')
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        <div
            ...
            <h1 class="h2">Mission & Vission </h1>
            <div class="btn-toolbar mb-2 mb-md-0">
                <a href="{{ route('dinings.index') }}" type="button" class="btn btn-sm btn-outline-secondary">
                    ...
                    <div class="col-6">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="text" name="property_label" class="form-control" placeholder="Property Label Name"
                                value="{{ old('property_label', $dinings->property_label) }}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div style="height: 120px; width: 200px; margin-top: 15px">
                                <img height="120" width="200" src="{{ asset($dinings->feature_image) }}" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="title">Description * </label>
                            <textarea type="text" name="description" rows="8" placeholder="Description"
                                class="form-control">{{ old('description', $dinings->description) }}</textarea>
                        </div>
                        <hr>
                        <div class="form-group">
                    ...
                    <div class="col-5">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <div class="field_wrapper">
                                ...
                                @if ($dinings->gallery)
                                    <?php $list = explode(',', $dinings->gallery); ?>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <div class="propperty_wrapper">
                                @if ($dinings->property_list)
                                    <?php $list = explode(',', $dinings->property_list); ?>
                                    @for ($i = 0; $i < sizeof($list); $i++)
                                        @if ($i == 0)
                                            <div class="add-more-area">

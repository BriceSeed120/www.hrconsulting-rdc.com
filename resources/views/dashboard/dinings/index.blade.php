    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        <div
            ...
            <div class="btn-toolbar mb-2 mb-md-0">
                <a href="{{ route('dinings.create') }}" type="button" class="btn btn-sm btn-outline-secondary">
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-primary" style="float: left"
                                    href="{{ route('dinings.show', $room->id) }}">View</a>
                                <a class="btn btn-secondary" style="float: left"
                                    href="{{ route('dinings.edit', $room->id) }}">Edit</a>
                                <form class="form-inline ml-2" method="POST" style="float: left;"
                                    action="{{ route('dinings.destroy', $room->id) }}">
                                    @method('delete')
                                    @csrf

...
@section('content')
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <div class="content">
            <form method="POST" action="{{ route('recreations.update', $recreations->id) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-6">
                        <div class="form-group mb-4">
                            ...
                            <input type="text" name="name" class="form-control" placeholder="Name"
                                value="{{ old('name', $recreations->name) }}">
                        </div>
                        <div class="form-group mb-4">
                            ...
                            <input type="text" name="property_label" class="form-control" placeholder="Property Label Name"
                                value="{{ old('property_label', $recreations->property_label) }}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div style="height: 120px; width: 200px; margin-top: 15px">
                                <img height="120" width="200" src="{{ asset($recreations->feature_image) }}" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="title">Description * </label>
                            <textarea type="text" name="description" rows="8" placeholder="Description"
                                class="form-control">{{ old('description', $recreations->description) }}</textarea>
                        </div>
                        <hr>
                        <div class="form-group">
                    ...
                    <div class="col-5">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <div class="propperty_wrapper">
                                @if ($recreations->property_list)
                                    <?php $list = explode(',', $recreations->property_list); ?>
                                    @for ($i = 0; $i < sizeof($list); $i++)
                                        @if ($i == 0)
                                            <div class="add-more-area">

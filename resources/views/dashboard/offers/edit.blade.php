                    ...
                    <div class="col-6">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="text" name="property_label" class="form-control" placeholder="Property Label Name"
                                value="{{ old('property_label', $offers->property_label) }}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div style="height: 120px; width: 200px; margin-top: 15px">
                                <img height="120" width="200" src="{{ asset($offers->feature_image) }}" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="title">Description * </label>
                            <textarea type="text" name="description" rows="8" placeholder="Description"
                                class="form-control">{{ old('description', $offers->description) }}</textarea>
                        </div>
                        <hr>
                        <div class="form-group">
                    ...
                    <div class="col-5">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <div class="field_wrapper">
                                ...
                                @if ($offers->gallery)
                                    <?php $list = explode(',', $offers->gallery); ?>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <div class="propperty_wrapper">
                                @if ($offers->property_list)
                                    <?php $list = explode(',', $offers->property_list); ?>
                                    @for ($i = 0; $i < sizeof($list); $i++)
                                        @if ($i == 0)
                                            <div class="add-more-area">

                ...
                <div class="col-6">
                    ...
                    <table class="table table-bordered table-hovered" style="">
                        ...
                        <tr>
                            ...
                            <td> {{ $offers->property_label }}</td>
                        </tr>
                        <tr>
                            <td> Rate in BTD(৳) </td>
                            <td> {{ $offers->rate_in_bdt }}</td>
                        </tr>
                        <tr>
                            <td> Rate in USD($) </td>
                            <td> {{ $offers->rate_in_usd }}</td>
                        </tr>

                        <tr>
                            <td> Feature Image </td>
                            <td> <img height="160" width="260" src="{{ asset($offers->feature_image) }}" /></td>
                        </tr>
                        <tr>
                            <td> Gallary Image </td>
                            <td>
                        ...
                        <tr>
                            <td> Property List </td>
                            <td>{{ $offers->property_list ? $offers->property_list : '' }} </td>
                        </tr>
                        <tr>
                            <td> Description </td>

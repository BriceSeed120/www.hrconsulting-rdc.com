...
@section('content')
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        <div
            ...
            <h1 class="h2">Our Technologies</h1>
            <div class="btn-toolbar mb-2 mb-md-0">
                <a href="{{ route('resturants.index') }}" type="button" class="btn btn-sm btn-outline-secondary">
        ...
        <div class="content">
            <form method="POST" action="{{ route('resturants.update', $resturants->id) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-6">
                        <div class="form-group mb-4">
                            ...
                            <input type="text" name="name" class="form-control" placeholder="Name"
                                value="{{ old('name', $resturants->name) }}">
                        </div>
                        <div class="form-group mb-4">
                            ...
                            <input type="text" name="property_label" class="form-control" placeholder="Property Label Name"
                                value="{{ old('property_label', $resturants->property_label) }}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div style="height: 120px; width: 200px; margin-top: 15px">
                                <img height="120" width="200" src="{{ asset($resturants->feature_image) }}" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="title">Description * </label>
                            <textarea type="text" name="description" rows="8" placeholder="Description"
                                class="form-control">{{ old('description', $resturants->description) }}</textarea>
                        </div>
                        <hr>
                        <div class="form-group">
                    ...
                    <div class="col-5">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <div class="field_wrapper">
                                ...
                                @if ($resturants->gallery)
                                    <?php $list = explode(',', $resturants->gallery); ?>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <div class="propperty_wrapper">
                                @if ($resturants->property_list)
                                    <?php $list = explode(',', $resturants->property_list); ?>
                                    @for ($i = 0; $i < sizeof($list); $i++)
                                        @if ($i == 0)
                                            <div class="add-more-area">

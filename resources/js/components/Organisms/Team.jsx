                        ...
                        <div className="col-md-4 member-box">
                            <div className="row">
                                ...
                                <div className="col-md-6 mt-2">
                                    <h6 className='mt-6'>Hubert NANA</h6>
                                    ...
                                    <a className='member-links' href="https://www.linkedin.com/in/hubert-nana-a1b9aa55/" target="_blank"><Icon.Linkedin className="icon" color="#09b6b0" /></a>
                        ...
                        <div className="col-md-4 member-box  ">
                            <div className="row ">
                                ...
                                <div className="col-md-8 mt-2">
                                    <h6 className='mt-6'>Salouck BAMBANG</h6>
                                    <p className="text-muted member-post">
                                    Chief Financial Officer (CFO), <br />
                                    Seed120 Ltd.
                                    </p>
                                    {/* <a href="https://twitter.com/"><Icon.Twitter className="icon" color="#09b6b0" /></a> */}
                                    <a href=" https://www.linkedin.com/in/salouck-bambang-8b16b336/" target="_blank"><Icon.Linkedin className="icon" color="#09b6b0" /></a>
                                </div>
                            </div>  
                    ...
                    <Fade>
                        <div className="col-md-4 member-box ">
                            <div className="row ">
                                ...
                                <div className="col-md-8 mt-2">
                                    <h6 className='mt-6'>Marcial TCHATCHOUA</h6>
                                    <p className="text-muted member-post">
                                        Chief Information Officer (CIO), <br />
                                        Seed120 Ltd.
                                    </p>
                                    {/* <a href="https://twitter.com/"><Icon.Twitter className="icon" color="#09b6b0" /></a> */}
                                    <a href="https://www.linkedin.com/in/marcial-tchatchoua-8723674/" target="_blank"><Icon.Linkedin className="icon" color="#09b6b0" /></a>
                                </div>
                            </div>  
                            <div className="member-text row ml-2">
                    ...
                    <Fade>
                        <div className="col-md-4 member-box">
                            <div className="row">
                                ...
                                <div className="col-md-8 mt-2">
                                    <h6 className='mt-6'>Mohammad Nur Alam  </h6>
                                    <p className="text-muted member-post">
                                        Chief Technology Officer (CTO), <br/>
                                        Seed120 Ltd.
                                    </p>
                                    {/* <a href="https://twitter.com/"><Icon.Twitter className="icon" color="#09b6b0" /></a> */}
                                    <a href="https://www.linkedin.com/in/sumon1216/" target="_blank"><Icon.Linkedin className="icon" color="#09b6b0" /></a>
                                </div>
                            </div>  
                            <div className="member-text row ml-2">
                        ...
                        <div className="col-md-4 member-box  ">
                            <div className="row ">
                                ...
                                <div className="col-md-8 mt-2">
                                    <h6 className='mt-6'>QUAZI RUHUL ABRAR</h6>
                                    <p className="text-muted member-post">
                                        Business Development Manager(BDM), <br />
                                        Seed120 Ltd.
                                    </p>
                                    {/* <a href="https://twitter.com/"><Icon.Twitter className="icon" color="#09b6b0" /></a> */}
                                    <a href=" https://www.linkedin.com/in/abrar806/" target="_blank"><Icon.Linkedin className="icon" color="#09b6b0" /></a>
                                </div>
                            </div>  
                        ...
                        <div className="col-md-4 member-box ">
                            <div className="row ">
                                ...
                                <div className="col-md-8 mt-2">
                                    <h6 className='mt-6'>Reaz Hossain</h6>
                                    <p className="text-muted member-post">
                                        Software Engineer, <br />
                                        Seed120 Ltd.
                                    </p>
                                    {/* <a href="https://twitter.com/"><Icon.Twitter className="icon" color="#09b6b0" /></a> */}
                                    <a href=" https://www.linkedin.com/in/reaz-hossain-42b736144/" target="_blank"><Icon.Linkedin className="icon" color="#09b6b0" /></a>
                                </div>
                            </div>  
                            <div className="member-text row ml-2">
                    ...
                    <Fade>
                        <div className="col-md-4 member-box">
                            <div className="row">
                                ...
                                <div className="col-md-6 mt-2">
                                    <h6 className='mt-6'>Michelle BIDIAS</h6>
                                    <p className="text-muted member-post">
                        ...
                        <div className="col-md-4 member-box  ">
                            <div className="row ">
                                ...
                                <div className="col-md-8 mt-2">
                                    <h6 className='mt-6'>Simon Brice MELONG</h6>
                                    <p className="text-muted member-post">
                                        Web & Graphic Designer, <br />
                                        Seed120 Ltd.
                                    </p>
                                    {/* <a href="https://twitter.com/"><Icon.Twitter className="icon" color="#09b6b0" /></a> */}
                                    <a href="https://www.linkedin.com/in/brice-melong-503443175/" target="_blank"><Icon.Linkedin className="icon" color="#09b6b0" /></a>
                                </div>
                            </div>  
